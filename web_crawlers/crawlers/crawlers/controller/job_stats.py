...
print('count of companies having job pages: {}'.format(comp_urls_cnt))

job_page_comps = grid_utils.get_company_urls(grid_utils.qa_job_desc_grid_id)
job_page_comps = set(job_page_comps)
job_page_comps_cnt = len(job_page_comps)
print('count of companies having jobs : {}'.format(job_page_comps_cnt))
...
print('count of companies having errors getting jobs: {}'.format(job_page_errs_cnt))
...
print('total companies crawled by Job Desc Spider: {}'.format(len(job_page_total_comps)))
